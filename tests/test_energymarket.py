...
def get_solpath():
    # Path to test solution file
    solpath = os.path.join(
        os.path.dirname(__file__), "localdata", "test_energymarket_solution.json"
    )
    return solpath
...
class TestPySO:
    def run_energymarket(self):
        ...
        pyenconfig = {
            "time": {"datefrom": "2032-02-01", "dateto": "2032-02-01"},
            "solve_arguments": {
                "kwargs": {
