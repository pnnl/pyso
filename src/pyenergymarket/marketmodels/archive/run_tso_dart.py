...
default_options = {
    ...
    "filename": '../../../../egret/egret/models/tests/uc_test_instances/tiny_uc_2.json', # Name (with path) to egret model_data file
...
if __name__ == '__main__':
    ...
    if not os.path.exists('tso_config_dart.json'):
        logger.critical("No configuration (tso_config_dart.json) found. Creating file with defaults.")
    ...
    with open('tso_config_dart.json', 'r') as f:
        options = json.load(f)
